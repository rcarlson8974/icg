...
def process_pdf(unprocessed_pdf):
    with open("reports/" + unprocessed_pdf + ".csv", 'w') as csvfile:
        ...
        competitors = ["Case Systems", "TMI", "Leedo", "Saco", "Hansen Company", "ACG", "Wilkie"]
        ...
        characteristics = ["3form", "AWI", "Cabinet", "Casework", "Corian", "Countertop", "Face Frame", "Formica", "FSC", "Glass", "Laminate", "Linear Feet", "Millwork", "PLAM", "Premium Grade", "Premium Grade", "QCP", "Solid Surface", "Stain", "Trim", "Woodworking"]
